...
public class AppData {
    ...
    public final static String SIGN_UP_SUCCESSFUL = "Sign up successful!";
    ...
    //email
    public final static String EMAIL_SUBJECT = "PDS OTP";

    //internet
    public final static String NO_INTERNET = "No Internet Connection!";
