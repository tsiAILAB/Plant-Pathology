    ...
    <div class="container col-md-8">
        <form style="margin-top: 40%">
            <div class="form-group">
                <input type="text" id="emailField" required class="input-area">
            ...
            <div class="text-center mt-3">
                <button class="btn rounded-btn text-def w-75" style="border-radius: 20px; font-weight: bold; color: #6B9790; border: 1px solid gray">Get Verification Code</button>
            </div>
        </form>
    </div>
</div>
