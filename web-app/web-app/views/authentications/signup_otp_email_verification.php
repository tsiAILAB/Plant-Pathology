...
require '../../controllers/signup_otp_email_verification_controller.php';
    ...
    <div class="container col-md-8">
        <form method="post" action="signup_otp_email_verification.php" style="margin-top: 35%">
            ...
            <div class="text-center mt-3">
                <input type="submit" name="signUpOtpSubmit" class="btn rounded-btn text-def w-100" style="border: 1px solid gray; color: #6B9790; font-weight: bold" value="Submit">
            </div>
        </form>
    </div>
</div>
